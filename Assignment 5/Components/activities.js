...
ReactDOM.render(
    React.createElement("form", {id: 'ContactForm', method: 'post', action: 'http://localhost/confirm.php' },
        ...
        React.createElement('input', {className: 'button', name: 'submit', type: 'submit', value: 'submit'}),
